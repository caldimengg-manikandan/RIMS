...
CREATE TABLE users (
	...
	PRIMARY KEY (id), 
	CONSTRAINT check_users_role CHECK (role IN ('super_admin', 'hr', 'recruiter', 'pending_hr', 'candidate')), 
...
CREATE TABLE applications (
	...
	PRIMARY KEY (id), 
	CONSTRAINT check_applications_status CHECK (status IN ('applied', 'screened', 'aptitude_round', 'ai_interview', 'interview_scheduled', 'interview_completed', 'hired', 'pending_approval', 'offer_sent', 'accepted', 'rejected', 'onboarded', 'physical_interview', 'review_later', 'permanent_failure')), 
