...
from app.schemas import UserRegister, UserLogin, TokenResponse, UserResponse, UserVerifyOTP
from app.auth import hash_password, verify_password, create_access_token, get_current_user, pwd_context
    ...
    if existing_user:
        if existing_user.is_verified:
            ...
            try:
                ...
                existing_user.otp_code = pwd_context.hash(raw_otp)
